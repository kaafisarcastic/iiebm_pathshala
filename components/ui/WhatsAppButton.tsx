...
type WhatsAppButtonProps = {
  /**
   * Lift it clear of the mobile call/apply bar. Off on pages without one,
   * where it can sit in the corner like any other floating action button.
   */
 ...
 *
 * On the IIEBM palette rule: WhatsApp green (#25D366) is deliberately the one
 * exception, for the same reason the recruiter logos keep their own colours —
 * it is a third-party brand identifier, not decoration. A blue or gold
